          ...
          <div className="cwb-closed-widget cwb-relative">
            ...
            {config.showChatPrompt && (
              <div className="cwb-chat-prompt cwb-absolute cwb-bottom-full cwb-right-0 cwb-mb-3 cwb-bg-white cwb-rounded-lg cwb-shadow-lg cwb-p-3 cwb-border cwb-max-w-xs cwb-min-w-48">
                ...
                <button
                  className="cwb-absolute c   wb-top-1 cwb-right-1 cwb-text-gray-400 hover:cwb-text-gray-600 cwb-transition-colors"
                  onClick={(e) => {
                    e.stopPropagation();
                  }}
                >
                  ...
                  {config.requiredFields.name && (
                    <div className="cwb-form-field">
                      ...
                      <input
                        ...
                        required
                        className="cwb-form-input cwb-w-full cwb-px-3 cwb-py-2 cwb-border cwb-border-gray-200 cwb-rounded-md cwb-text-sm cwb-outline-none cwb-ring-2 cwb-ring-opacity-50"
                        style={{
                    ...
                    >
                      <div className={`cwb-flex cwb-gap-2 sm:cwb-gap-3 cwb-max-w-xs sm:cwb-max-w-80 ${message.isUser ? 'cwb-flex-row-reverse' : 'cwb-flex-row'}`}>
                        ...
                        <div className="cwb-flex cwb-flex-col cwb-gap-1 sm:cwb-gap-2 cwb-min-w-0">
                          ...
                          {/* Message Status */}
                          {message.isUser && config.showMessageStatus && (
